...
Route::middleware('auth')->controller(GroupChatController::class)->group(function () {
...
//     Route::post('/group/chat-image/delete', [GroupChatController::class, 'deleteGroupChatImage'])->name('deleteImage');
// });
// });
